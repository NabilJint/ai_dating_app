...
export default function ChatListScreen() {
  ...
  const matchWithMessages = useQuery(
  ...
  const renderChatItem = ({
    ...
    item: NonNullable<typeof matchWithMessages>[number];
  }) => {
    ...
    const renderNewMatches = () => {
      const newMatches =
        matchWithMessages?.filter((m) => !m.lastMessage) || [];
  ...
  const conversations = matchWithMessages?.filter((m) => m.lastMessage) || [];
