...
import { supportsGlassEffect, AdaptiveGlassView } from "@/lib/glass";
...
export default function profile() {
  ...
  const { currentUser: profile, clerkUser, isLoading } = useCurrentUser();
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.contentSection}>
          ...
          {profile.bio && (
            <View style={styles.bioSection}>
              <Text style={[styles.bioQuote, { color: colors.primary }]}>
                &ldquo;
              </Text>
                  ...
                  <View style={styles.lookingForDetails}>
                    ...
                    >
                      ...
                      <Text style={{ fontWeight: "400", opacity: 0.7 }}>
                        {profile.ageRange?.min || 18}-
                        {profile.ageRange?.max || 99}
                      </Text>
                    </Text>
                  </View>
                </View>
        ...
        >
          ...
          />
          <Text
            style={[styles.signOutText, { color: colors.error || "#FF3B30" }]}
          >
            Sign Out
          </Text>
        </TouchableOpacity>
