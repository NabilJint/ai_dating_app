...
export function DailyPickCard({
  ...
  const headerHeight = insets.top + 12 + 60 + 36; // top inset + padding + title height + bottom padding
        ...
        <View style={styles.matchCard}>
          ...
          >
            <View style={styles.insightHeader}>
              ...
              <Text
                style={[styles.aiLabel, { color: colors.onPrimaryContainer }]}
              >
                AI Pick
              </Text>
            </View>
        ...
        {user.lookingFor && user.lookingFor.length > 0 && (
          <View style={[styles.section, { backgroundColor: colors.surface }]}>
            ...
            <View style={styles.lookingForRow}>
              ...
              <Text
                style={[styles.lookingForText, { color: colors.onBackground }]}
              >
                {user.lookingFor
