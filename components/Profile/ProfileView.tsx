...
import PhotoIndicators from "../ui/PhotoIndicators";
import PhotoTapZones from "../ui/PhotoTapZones";
import { AdaptiveGlassView } from "@/lib/glass";

const PHOTO_HEIGHT = SCREEN_HEIGHT * 0.55;

interface ProfileViewProp {
  user: Doc<"users">;
  distance?: number | null;
}
export function ProfileView({ user, distance }: ProfileViewProp) {
  ...
  const handlePhotoTap = (side: "right" | "left") => {
    if (side === "right") {
