...
// Locations around Lagos area (spread around base coordinate)
const lagosLocations = [
  { latitude: 6.7288, longitude: 3.5277 }, // Center
  { latitude: 6.7308, longitude: 3.5297 },
  { latitude: 6.7268, longitude: 3.5257 },
  { latitude: 6.7328, longitude: 3.5237 },
  { latitude: 6.7248, longitude: 3.5317 },
  { latitude: 6.7348, longitude: 3.5277 },
  { latitude: 6.7228, longitude: 3.5337 },
  { latitude: 6.7368, longitude: 3.5217 },
  { latitude: 6.7208, longitude: 3.5197 },
  { latitude: 6.7388, longitude: 3.5357 },
  { latitude: 6.7188, longitude: 3.5297 },
  { latitude: 6.7408, longitude: 3.5257 },
  { latitude: 6.7168, longitude: 3.5237 },
  { latitude: 6.7428, longitude: 3.5317 },
  { latitude: 6.7148, longitude: 3.5277 },
  { latitude: 6.7448, longitude: 3.5337 },
  { latitude: 6.7128, longitude: 3.5197 },
  { latitude: 6.7468, longitude: 3.5357 },
  { latitude: 6.7108, longitude: 3.5217 },
  { latitude: 6.7488, longitude: 3.5297 },
];
...
const maxDistances: (number | undefined)[] = [
  ...
  50,
  100,
  undefined, // 5 options cycling through profiles
  25,
  50,
  100,
  undefined,
 ...
 */
export const demoProfiles: DemoProfile[] = baseProfiles.map(
  (profile, index) => {
    return {
      ...profile,
      location: lagosLocations[index % lagosLocations.length],
